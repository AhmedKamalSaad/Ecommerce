...
import { Grid3X3, HomeIcon, SearchIcon, ShoppingCart } from "lucide-react";
...
const NavBar = () => {
  ...
  return (
    ...
    >
      <nav className="max-w-[600px]  w-full flex flex-wrap justify-evenly shadow-2xl text-white *:py-1 *:px-2  rounded-3xl  bg-slate-950  py-5 *:border *:rounded-xl *:transition-colors *:duration-300 hover:*:bg-gray-200 hover:*:text-black   focus-visible:*:bg-gray-200 focus-visible:*:outline-none focus-visible:*:text-black">
